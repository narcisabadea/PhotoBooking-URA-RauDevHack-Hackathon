...
PhotoBooking App is created using Vue.js, Vuetify, Vuex, Firebase.

The application recommends a suitable photographer for a customer's event, according to his visual preferences, budget and period. 
...
* Both types of users can see a list of their requests and status 
